...
class RepaymentRecordController {
    ...
    @GetMapping
    public List<RepaymentRecord> getAllRepaymentRecords(@RequestParam
        ...
        return repaymentRecordService.getAllRepaymentRecords(offset,size,keyword);
    }
    @GetMapping("total")
    public List<Object> getTotal(@RequestParam Map<String,Object> attribute) {
        System.out.println(attribute);
        String keyword = (String) attribute.get("keyword");
        return repaymentRecordService.getTotal(keyword);
    }
}
